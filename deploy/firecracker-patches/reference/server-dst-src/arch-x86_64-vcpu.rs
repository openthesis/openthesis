...
pub struct KvmVcpu {
    ...
    pub dst_rdtsc_exiting: bool,
    pub dst_pmc_prev: u64,
    /// Base host TSC captured on first RDTSC exit during boot.
    /// Used to inject guest-compatible TSC before burst runs start.
    pub dst_boot_tsc_base: u64,
}
